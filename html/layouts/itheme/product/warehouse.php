...
/** @var object $product Объект товара */
    ...
    <div class="card-body">
        <div class="position-relative">
            ...
            <a class="stretched-link"
               href="<?php echo Route::_(RouteHelper::getWarehouseRoute((int)$item->id)); ?>"><span class="visually-hidden">Подробнее</span></a>
        </div>
        <div class="row gy-1 mt-3">
            <div><?php echo LayoutHelper::render('itheme.product.booking', ['item' => $product, 'class' => 'btn-primary w-100']); ?></div>
            <div><a class="btn btn-outline-primary w-100"
               href="https://yandex.ru/maps/?rtext=~<?php echo $item->latitude,',',$item->longitude; ?>"
               target="_blank"><?php echo LayoutHelper::render('itheme.icon', ['icon' => 'i-geo', 'class' => 'me-1']); ?>Маршрут</a></div>
        </div>
    </div>
</div>